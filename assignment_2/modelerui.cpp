...
ModelerUserInterface::ModelerUserInterface() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = m_controlsWindow = new Fl_Double_Window(395, 325, "Derek Dorr - Assignment 2 Controls");
    w = o;
  ...
  { Fl_Double_Window* o = m_modelerWindow = new Fl_Double_Window( 800, 800, "Derek Dorr - Assignment 2 Model");
    w = o;
